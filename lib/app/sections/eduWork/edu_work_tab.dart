...
class EduWorkTab extends StatefulWidget {
  const EduWorkTab({super.key});

  @override
  State<EduWorkTab> createState() => _EduWorkTabState();
}

class _EduWorkTabState extends State<EduWorkTab> {
  @override
