...
List<CertificatesUtils> certificatesUtils = [
  ...
  CertificatesUtils(
    ...
    length: 10,
    description:
        '''During the curse I get along with basic and advanced concepts of TS.
  ...
  CertificatesUtils(
    ...
    length: 30,
    description: '''
• Responsive UI, navigation in multiple-screens app 
• State management with Riverpod 
• animations: Animated Builder() AnimatedSwitcher() 
• working with Form() 
• form inputs validation 
• setting simple backend using Firebase 
• http package 
• error handling 
• using native devices features 
• image_picker package 
• using device camera for taking pictures 
• user current location with 'location package'
• Google maps API 
• Firebase CLI & SKD, 
...
• OpenAI request parameters''',
  ...
  CertificatesUtils(
    ...
    length: 22,
    description: '''
• Creating database or interacting with existing databases 
• Writing complex SQL join queries across multiple tables
• MySQL 8 Window Functions (LEAD, LAG, RANK, etc.) 
• Model real-world data and generate reports using SQL 
• Answer company performance or sales questions using data 
• MySQL 8.x syntax introduction to its applications in Node.js''',
  ),
  CertificatesUtils(
